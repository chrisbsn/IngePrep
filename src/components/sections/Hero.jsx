    ...
    <section className="hero" id="top">
      <Container className="hero__inner">
        <div className="hero__content">
          <span className="hero__badge">Lancement septembre 2026 — UCLouvain · ULB · ULiège · UMons</span>
          ...
          <p className="hero__note">Gratuit de s'inscrire. Aucun paiement à ce stade.</p>
        </div>
            ...
            <div className="hero__card-diagnostic">
              ...
              <div>
                ...
                <p className="hero__card-diagnostic-text">
                  Configuration non conforme aux conditions du théorème — les droites ne sont pas
                  concourantes comme supposé à l'étape 2.
                </p>
              </div>
            </div>
