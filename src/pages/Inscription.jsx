...
// Déduit un prénom d'affichage à partir de l'email (aucun vrai compte à
// interroger : simulation locale, rien n'est vérifié).
...
// Création de compte GRATUITE et simulée : même formulaire que /connexion, même
// objet de compte (useCompteSimule) — celui qui donne accès au tableau de bord,
// à la banque complète d'annales et au compteur de corrections gratuites. Aucun
// tarif, aucun Stripe ici : le paiement vit sur la carte tarif (#tarif).
      ...
      <main className="connexion">
        <div className="connexion__carte">
          <div className="connexion__banniere" role="note">
            <strong>⚠ Compte simulé.</strong> Ton mot de passe n'est ni vérifié ni stocké de
          ...
          <h1 className="connexion__titre">Crée ton compte gratuit</h1>
          <p className="connexion__sous-titre">
            Accède à ton tableau de bord, à la banque complète d'annales et à tes corrections
            gratuites.
          </p>
          ...
          <form className="connexion__form" onSubmit={handleSubmit}>
            ...
            <p className="connexion__note-mdp">
              Simulation : le mot de passe saisi n'est pas vérifié, tu peux entrer directement.
            </p>
